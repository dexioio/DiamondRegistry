/**
 * This testing file was provided by the OpenZeppelin team to verify that the
 * ERC721 token implementation works as expected.
 */
...
contract('ERC721Token', accounts => {
  ...
  function () {
    it('has a total supply equivalent to the inital supply',
    async function () {
  ...
  describe('mint', function () {
    ...
    function () {
      ...
      function () {
        ...
        it('mints the given token ID to the given address',
        async function () {
        ...
        it('adds that token to the token list of the owner',
        async function () {
          await token.mint(to, tokenId);
  ...
  describe('burn', function () {
    ...
    function () {
      ...
      describe('when the msg.sender owns given token', function () {
        ...
        it('burns the given token ID and adjusts the balance of the owner',
        async function () {
        ...
        it('removes that token from the token list of the owner',
        async function () {
          await token.burn(tokenId, { from: sender });
  ...
  describe('transfer', function () {
    describe('when address to transfer the token to is not the zero address',
    function () {
      const to = accounts[1];
      ...
      function () {
        ...
        function () {
          ...
          it('transfers ownership of the given token ID to the given address',
          async function () {
          ...
          it('emits an approval and transfer events',
          async function () {
          ...
          it('adds the token to the tokens list of the new owner',
          async function () {
            await token.transfer(to, tokenId, { from: sender });
  ...
  describe('approve', function () {
    ...
    function () {
      ...
      function () {
        ...
        describe('address that receives the approval is not the 0 address',
        function () {
          describe('address that receives the approval is different than owner',
          function () {
            const to = accounts[1];

            describe('when there was no approval for the given token ID before',
            function () {
              it('approves the token ID to the given address',
              async function () {
                await token.approve(to, tokenId, { from: sender });
            ...
            describe('when the given token ID was approved for same account',
            function () {
              beforeEach(async function () {
                await token.approve(to, tokenId, { from: sender });
              });
            ...
            function () {
              ...
              it('changes the approval to the given address',
              async function () {
                await token.approve(to, tokenId, { from: sender });
          ...
          function () {
            ...
            function () {
              it('reverts', async function () {
                await assertRevert(token.approve(to, tokenId,
                  { from: sender }));
              });
            });
      ...
      function () {
        ...
        it('reverts', async function () {
          await assertRevert(token.approve(accounts[2], tokenId,
            { from: sender }));
        });
      });
    });
    ...
    function () {
      ...
      it('reverts', async function () {
        await assertRevert(token.approve(accounts[1], tokenId,
          { from: _creator }));
      });
    });
  });
  ...
  describe('takeOwnership', function () {
    ...
    function () {
      ...
      function () {
        ...
        it('transfers the ownership of the given token ID to the given address',
        async function () {
